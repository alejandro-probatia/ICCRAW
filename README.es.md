...
ProbRAW 0.3.18 es adecuado para pruebas controladas, revisión metodológica y
validación de candidata a release. Todavía no es un sistema certificado para
producción científica o forense.

La version actual corrige el deshacer tras cambios de geometria de visor
recorte/nivelado para que volver atras no fuerce una reconstruccion final de
preview innecesaria. Mantiene las mejoras de rendimiento interactivo de 0.3.17.
