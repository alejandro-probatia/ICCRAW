...
class ProfileWorkflowMixin:
    ...
    def _new_custom_reference_catalog(self) -> None:
        ...
        try:
            ...
            payload["reference_source"] = "Medición personalizada introducida en NexoRAW"
        except Exception:
    ...
    def _open_reference_editor(self, payload: dict[str, Any], *, target_path: Path | None) -> None:
        ...
        reference_source = QtWidgets.QLineEdit(
            str(payload.get("reference_source") or payload.get("source") or "Medición personalizada introducida en NexoRAW")
        )
    ...
    def _reference_payload_from_table(
        ...
        *,
        ...
        return {
            ...
            "reference_source": reference_source.strip() or "Medición personalizada introducida en NexoRAW",
