...
from .color import delta_e76, delta_e2000, summarize
from .models import ErrorSummary, PatchError, ProfileBuildResult, Recipe, SampleSet, ValidationResult
...
def build_profile(
    ...
    metadata = {
        ...
        "algorithm_version": "0.1.0-python",
...
def _build_profile_with_argyll(
    ...
    with tempfile.TemporaryDirectory(prefix="icc_entrada_argyll_") as tmp:
        tmpdir = Path(tmp)
