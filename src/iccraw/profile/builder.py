...
def build_profile(
    ...
    _build_profile_with_argyll(
        ...
        patch_ids=patch_ids,
        description=f"NexoRAW {samples.chart_name} {samples.chart_version}",
...
def write_samples_cgats(samples: SampleSet, out_path: Path) -> None:
    ...
    _write_ti3(
        ...
        reference_lab,
        patch_ids,
        descriptor=f"NexoRAW {samples.chart_name} {samples.chart_version} samples",
        chart_name=samples.chart_name,
        chart_version=samples.chart_version,
        illuminant=samples.illuminant,
...
def _write_ti3(
    ...
    patch_ids: list[str],
    *,
    descriptor: str = "NexoRAW chart samples",
    ...
    lines.append('ORIGINATOR "NexoRAW"')
...
def build_matrix_shaper_icc(description: str, matrix_camera_to_xyz: np.ndarray, gamma: float) -> bytes:
    ...
    tags: dict[bytes, bytes] = {
        ...
        b"cprt": _text_type("Generated by NexoRAW"),
