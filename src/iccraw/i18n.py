...
Las traducciones se almacenan en src/iccraw/resources/locales/<lang>.qm
...
1. Extraer cadenas nuevas del código fuente:
       pyside6-lupdate src/iccraw/gui.py [otros .py] -ts locales/en.ts
...
3. Compilar a binario:
       pyside6-lrelease locales/en.ts -qm src/iccraw/resources/locales/en.qm
...
def _qm_path(lang: str) -> Path | None:
    ...
    try:
        locale_dir = resources.files("iccraw.resources").joinpath("locales")
