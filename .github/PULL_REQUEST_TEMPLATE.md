...
- [ ] Licencia compatible si se anade dependencia o asset.

## Resumen del cambio

Describe alcance, motivacion y riesgo tecnico.

## Evidencia

Incluye comandos ejecutados, logs relevantes o artefactos (`qa_session_report.json`,
`*.profile.json`, `batch_manifest.json`) cuando aplique.
