...
ProbRAW 0.3.17 is suitable for controlled testing, method review and release
candidate validation. It is not yet a certified scientific or forensic
production system.

The current version improves interactive preview responsiveness and repeated
RAW session work: lateral chromatic-aberration maps are reused during slider
edits, vibrance/saturation and false-color suppression allocate less temporary
memory, and demosaic cache pruning is rate-limited during batch/cache writes.
