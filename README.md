...
ProbRAW 0.3.16 is suitable for controlled testing, method review and release
candidate validation. It is not yet a certified scientific or forensic
production system.

The current version improves TIFF export control and GUI review: compressed
TIFF exports support selectable codecs and bounded compression workers, visual
leveling uses a draggable angle line, the folder tree can open directories in
the system file browser, and the render queue shows per-file progress bars.
